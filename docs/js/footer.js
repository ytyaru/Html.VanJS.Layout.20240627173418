...
class Footer {
    constructor(author, prePath) {
        ...
        this._created = '2024-06-27T17:34:11+0900'
    ...
    #project() { return a(this.#externalLinkAttr(({href:`https://github.com/${this._author}/Layout/`})), img({class:'icon', src:`${this._prePath}asset/image/logo/github/black.svg`})) }
